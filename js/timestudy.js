...
ns({x:     0, y:    -4, id:  "g12", cost:    2, desc: "Replicanti grow faster based on tickspeed.", eff: function() {return getTickspeed("infinityDimension").log(100).max(1)}, pre: ["g11"]})
ns({x:     1, y:    -3, id:  "g21", cost:    6, desc: "Second Time Dimension gains a boost based on galaxies.", eff: function() {return getEffectiveGalaxies().add(1).pow(0.5)}, pre: ["g12"]})
ns({x:    -1, y:    -3, id:  "g22", cost:    6, desc: "Third Time Dimension gains a boost based on eternity points.", eff: function() {return game.eternityPoints.add(1).pow(0.75)}, pre: ["g12"]})
...
ns({x:    -1, y:     4, id:  "d12", cost: 1000, desc: "Unlock time dimensions 5 and 6", pre: ["d11"],})
ns({x:     0, y:     4, id:  "d21", cost: 5000, desc: "Unlock time dimensions 7 and 8", pre: ["d12"],})
