...
ns({x:     4, y:    -2, id:  "s02", cost:    0, desc: "Eternity Challenge 1", pre: ["i32"]})
...
ns({x:     0, y:    -4, id:  "g12", cost:    2, desc: "Replicanti grow faster based on tickspeed.", eff: function() {return getTickspeed("infinityDimension").pow(0.5).divide(1e70).add(1).log(10000).max(1)}, pre: ["g11"]})
