...
ns({x:     2, y:    -3, id:  "i32", cost:   12, desc: "Replicanti boost is powered up.", pre: ["i21"]})
...
ns({x:     0, y:    -4, id:  "g12", cost:    2, desc: "Replicanti grow faster based on tickspeed.", eff: function() {return getTickspeed("infinityDimension").log(100)}, pre: ["s00"]})
