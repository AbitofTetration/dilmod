...
ns({x:     5, y:    -2, id:  "i41", cost:  370, desc: "Infinity Dimensions gain a boost based on eternity challenge completions.", eff: function() {return Decimal.pow(getChallengeCompletions(2), 100).max(1)}, pre: ["s02"]})
...
ns({x:     0, y:     4, id:  "c11", cost:   10, desc: "Dimensional boosts are 0.01% more effective for each tick upgrade gained from Time Dimensions", eff: function() {return getFreeTickspeedUpgrades().divide(1000000).add(1)}, pre: ["s00"],})
ns({x:     2, y:     5, id:  "c12", cost:   15, desc: "The formula for replicanti multiplier is better.", pre: ["c11"],})
ns({x:    -2, y:     5, id:  "c21", cost:   15, desc: "Sacrifice provides a greater boost to the eighth dimension.", eff: function() {return getFreeTickspeedUpgrades().divide(1000000).add(1)}, pre: ["c11"],})
