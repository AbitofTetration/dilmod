...
ns({x:    -4, y:     5, id:  "t52", cost:  320, desc: "Time Dimensions gain a boost based on eternity points.", eff: function() {return game.eternityPoints.add(1).log(10).pow(10).max(1)}, pre: ["t51"]})
