...
ns({x:     0, y:     3, id:  "d11", cost:  200, desc: "Unlock Time Dilation", pre: ["s00"], req: function() {return getChallengeCompletions(2) >= 6}})
...
ns({x:     0, y:     5, id:  "d31", cost: 1e11, desc: "Unlock ex-dilation", pre: ["d22"],})
