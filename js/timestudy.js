...
ns({x:     2, y:     6, id:  "c13", cost:   15, desc: "Infinity Shifts are 25% cheaper.", pre: ["c11"],})
ns({x:     0, y:     6, id:  "c12", cost:   15, desc: "The formula for replicanti multiplier is better.", pre: ["c11"],})
...
ns({x:   1.5, y:     7, id:  "c35", cost:   15, desc: "Dimension boosts are 15% cheaper.", pre: ["c13"],})
ns({x:   2.5, y:     7, id:  "c36", cost:   15, desc: "You gain 25% more replicated galaxies.", pre: ["c13"],})
