...
ns({x:    -3, y:     2, id:  "t41", cost:   20, desc: "The free tickspeed given from Time Dimensions is multiplied by 1.1.", eff: function() {return 1.1}, pre: ["t31"]})
ns({x:    -2, y:     1, id:  "g11", cost:    1, desc: "Galaxies are 1% stronger.", eff: function() {return 1.01}, pre: ["s00"]})
ns({x:     0, y:    -3, id:  "r11", cost:   10, desc: "Decrease galaxy cost scaling by 10%", pre: ["s00"]})
