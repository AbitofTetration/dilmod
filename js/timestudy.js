...
ns({x:     0, y:    10, id:  "n11", cost:   20, desc: "You gain 1e3080x more IP.", pre: ["s13"]})
ns({x:     0, y:    11, id:  "n12", cost:   30, desc: "You gain 1e30x more EP.", pre: ["n11"]})
ns({x:     0, y:    12, id:  "d11", cost:  200, desc: "Unlock Time Dilation.<br>Requirement: Complete five eternity challenges.", pre: ["n12"], req: function() {return getChallengeCompletions(2) >= 5}})
